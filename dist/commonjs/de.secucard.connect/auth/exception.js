...
exports.AuthenticationTimeoutException = exports.AuthenticationFailedException = void 0;
...
var AuthenticationFailedException = function (_Error) {
  ...
  var _super = _createSuper(AuthenticationFailedException);
  function AuthenticationFailedException() {
    ...
    Object.defineProperty(_assertThisInitialized(_this), 'error_user', {
      configurable: true,
      enumerable: false,
      writable: true,
      value: ''
  ...
  return _createClass(AuthenticationFailedException);
...
var AuthenticationTimeoutException = function (_Error2) {
  ...
  var _super2 = _createSuper(AuthenticationTimeoutException);
  function AuthenticationTimeoutException() {
    ...
    if (Error.captureStackTrace) {
      ...
      Object.defineProperty(_assertThisInitialized(_this2), 'stack', {
        configurable: true,
        enumerable: false,
        writable: true,
        value: Error(message).stack
    ...
    Object.defineProperty(_assertThisInitialized(_this2), 'message', {
      configurable: true,
      enumerable: false,
      writable: true,
      value: message
  ...
  return _createClass(AuthenticationTimeoutException);
}(_wrapNativeSuper(Error));
