...
var UploadService = function (_ProductService) {
  ...
  _createClass(UploadService, [{
    ...
    value: function upload(base64str) {
      return _get(_getPrototypeOf(UploadService.prototype), "execute", this).call(this, null, null, null, {
        content: base64str
      }, {
        channelConfig: ['rest'],
        useAuth: false
    ...
    value: function uploadMultiForm(files) {
      return _get(_getPrototypeOf(UploadService.prototype), "create", this).call(this, null, {
        channelConfig: ['rest'],
        useAuth: false
      }, {
        files: files
