...
var SecupayPrepay = function (_Transaction) {
  ...
  var _super = _createSuper(SecupayPrepay);
  function SecupayPrepay(transfer_purpose, transfer_account, customer, contract, amount, currency, purpose, order_id, trans_id, status, transaction_status) {
    ...
    _this = _super.call(this, customer, contract, amount, currency, purpose, order_id, trans_id, status, transaction_status);
    _this.transfer_purpose = transfer_purpose;
    _this.transfer_account = transfer_account;
    return _this;
  }
  return _createClass(SecupayPrepay);
