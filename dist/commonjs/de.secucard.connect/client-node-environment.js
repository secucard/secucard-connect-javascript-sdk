...
exports.ServiceMap = exports.ClientNodeEnvironment = void 0;
...
var ServiceMap = {
  ...
  Event: {
    Actions: _event.Event.ActionService.Uid
  },
  General: {
  ...
  Payment: {
    ...
    Mandates: _payment.Payment.MandateService.Uid,
